...
void MainWindow::createFileMenu()
{
    ...
    ADD_ACTION(ACTION_EJECT_SD, fileMenu);
...
void MainWindow::createViewMenu()
{
    ...
    ADD_ACTION(ACTION_SHOW_CIRCUIT_BYTES, menu);
...
void MainWindow::createToolbar()
{
    ...
    ADD_ACTION(ACTION_TOOLBAR_EJECT_SD, toolbar);
}
...
void MainWindow::about()
{
    ...
    QMessageBox::about( this,
                        ...
                        tr("DROID Forge version %1.\n\n"
                           ...
                           "Copyright Mathias Kettner 2025.\n\n"

                           "Built with Qt version %3.\n\n"
                        ...
                        .arg(APPLICATION_VERSION, firmware_version, QT_VERSION_STR));
}
